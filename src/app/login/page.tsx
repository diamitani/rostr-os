    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex flex-1 bg-zinc-900 items-center justify-center p-12">
        <div className="max-w-md">
          <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-blue-500 to-violet-500 flex items-center justify-center text-xl font-bold mb-6">
            R
          </div>
          <h1 className="text-4xl font-bold mb-4">Welcome back to ROSTR OS</h1>
          <p className="text-zinc-400 leading-relaxed">
            The AI-native project OS. NPAO task prioritization, 4Ds lifecycle, and PAL-powered
            project intake — all open source.
          </p>
