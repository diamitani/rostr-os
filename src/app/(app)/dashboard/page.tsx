...
export default function DashboardPage() {
  ...
  const npaoData: { cls: NPAOClass; label: string; count: number; color: string }[] = [
    { cls: "N", label: "Necessity", count: stats.npao.N, color: "bg-red-500" },
    { cls: "A", label: "Anxiety", count: stats.npao.A, color: "bg-amber-500" },
    { cls: "P", label: "Priority", count: stats.npao.P, color: "bg-blue-500" },
    { cls: "O", label: "Opportunity", count: stats.npao.O, color: "bg-emerald-500" },
  ];
  ...
  return (
    <div className="p-8 max-w-6xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-zinc-400">ROSTR-powered project overview</p>
      </div>
              ...
              return (
                <div key={p.phase} className="flex items-center justify-between">
                  ...
                  <div className="text-right">
                    ...
                    <div className="text-xs text-zinc-500">{count} tasks</div>
                  </div>
                </div>
              );
            })}
      ...
      <div className="p-6 rounded-xl border border-zinc-800 bg-zinc-900/50">
        ...
        {projects.length === 0 ? (
          <div className="text-center py-8 text-zinc-500">
            ...
            <p>No projects yet. Create one or use AI Intake.</p>
          </div>
        ) : (
              ...
              >
                <div>
                  ...
                  <div className="text-xs text-zinc-500 mt-0.5">
                    N:{p.n_count} A:{p.a_count} P:{p.p_count} O:{p.o_count}
                  </div>
                </div>
                <span
                  className={cn(
